...
export default function Column({ column, onTaskClick, onCreateTaskClick }: ColumnProps) {
  ...
  return (
    ...
    >
      <div
        className={`flex justify-between items-center p-4 rounded-t-xl border-b border-l-4 ${getColumnHeaderColor()}`}
      >
      ...
      <div className="overflow-visible flex-1 p-4">
        {tasks.length === 0 ? (
          <div
            className={`p-8 text-center text-sm border-2 border-dashed rounded-xl transition-all duration-200 ${
              isOver

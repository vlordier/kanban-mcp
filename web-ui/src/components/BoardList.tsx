...
import { getAllBoards, deleteBoard, exportDatabase, importDatabase } from '../services/api';
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!data.boards || !data.columns || !data.tasks) {
        alert('Invalid file format. The file must contain boards, columns, and tasks arrays.');
        return;
      }

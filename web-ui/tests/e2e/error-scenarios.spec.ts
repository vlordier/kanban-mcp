...
test.describe('Error Scenarios and Edge Cases', () => {
  ...
  test('Network error handling and recovery', async ({ page }) => {
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/01-board-created-${timestamp}.png`,
      fullPage: true,
    });

    // Navigate to board
    await page
      .locator(`tr:has-text("Network Test ${timestamp}") a:has-text("View")`)
      .first()
      .click();
    await page.waitForTimeout(1000);
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/02-slow-network-state-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page
      ...
      .fill('Testing task creation with slow network conditions');

    await page.screenshot({
      path: `screenshots/error-scenarios/03-task-form-slow-network-${timestamp}.png`,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/04-task-created-slow-network-${timestamp}.png`,
      fullPage: true,
    });
  ...
  test('Data integrity and concurrent operations', async ({ page }) => {
    ...
    await page
      ...
      .fill('Testing concurrent operations and data integrity');
    await page.locator('button:has-text("Create Board")').click();
    await page.waitForTimeout(1000);

    await page
      .locator(`tr:has-text("Concurrent Test ${timestamp}") a:has-text("View")`)
      .first()
      .click();
    await page.waitForTimeout(1000);

    await page.screenshot({
      path: `screenshots/error-scenarios/05-concurrent-test-board-${timestamp}.png`,
      fullPage: true,
    });

    // Create multiple tasks rapidly
    const tasks = ['Rapid Task 1', 'Rapid Task 2', 'Rapid Task 3', 'Rapid Task 4'];
    ...
    for (const taskTitle of tasks) {
      ...
      await page
        .locator('textarea#task-content')
        .fill(`Content for ${taskTitle} - testing rapid creation`);
      await page.locator('button:has-text("Create Task")').click();
    ...
    await page.waitForTimeout(1000);
    await page.screenshot({
      path: `screenshots/error-scenarios/06-rapid-tasks-created-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.waitForTimeout(1000);
    await page.screenshot({
      path: `screenshots/error-scenarios/07-rapid-moves-completed-${timestamp}.png`,
      fullPage: true,
    });
  ...
  test('Extreme content and unicode handling', async ({ page }) => {
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/09-unicode-board-list-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/10-unicode-board-detail-${timestamp}.png`,
      fullPage: true,
    });
...
Complex emoji: 👨‍👩‍👧‍👦 👩‍💻 🧑‍🚀 🏳️‍🌈
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/11-extreme-content-form-${timestamp}.png`,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/12-extreme-content-created-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/13-extreme-content-rendered-${timestamp}.png`,
      fullPage: true,
    });
  ...
  test('Browser compatibility and viewport edge cases', async ({ page }) => {
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/14-narrow-viewport-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.locator('button:has-text("New Board")').click();
    await page.screenshot({
      path: `screenshots/error-scenarios/15-create-dialog-narrow-${timestamp}.png`,
    });
    ...
    await page
      .locator(`tr:has-text("Mobile Test ${timestamp}") a:has-text("View")`)
      .first()
      .click();
    await page.waitForTimeout(1000);

    await page.screenshot({
      path: `screenshots/error-scenarios/16-board-narrow-viewport-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/17-task-form-narrow-${timestamp}.png`,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/18-task-created-narrow-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/19-wide-viewport-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/20-tall-viewport-${timestamp}.png`,
      fullPage: true,
    });
...
This content should be safely rendered without executing any scripts.
    ...
    for (const attempt of xssAttempts) {
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/21-xss-board-form-${timestamp}.png`,
      });
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/22-xss-board-created-${timestamp}.png`,
        fullPage: true,
      });
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/23-xss-board-detail-${timestamp}.png`,
        fullPage: true,
      });
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/24-xss-task-form-${timestamp}.png`,
      });
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/25-xss-task-created-${timestamp}.png`,
        fullPage: true,
      });
      ...
      await page.screenshot({
        path: `screenshots/error-scenarios/26-xss-task-detail-${timestamp}.png`,
        fullPage: true,
      });
  ...
  test('Memory and performance edge cases', async ({ page }) => {
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/27-large-content-form-${timestamp}.png`,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/28-large-content-board-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/29-rapid-tasks-${timestamp}.png`,
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: `screenshots/error-scenarios/30-memory-test-final-${timestamp}.png`,
      fullPage: true,
    });
  });
});

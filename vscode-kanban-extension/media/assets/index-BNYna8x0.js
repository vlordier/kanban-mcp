...
async function exportDatabase() {
  if (isVSCodeWebview$1()) {
    const data = await vsCodeApiRequest("GET", "/export");
...
async function exportToFileSystem(options) {
  if (!isVSCodeWebview$1()) {
    throw new ApiException("File system export only available in VSCode extension", 501);
  }
  return vsCodeApiRequest("POST", "/export-to-file", options);
}
...
function useImportExport() {
  ...
  const fileSystemExportMutation = useMutation({
    mutationFn: (options) => exportToFileSystem(options),
    onSuccess: (response) => {
      if (response.success) {
        const { stats, files } = response;
        const fileCount = (files == null ? void 0 : files.length) || 0;
        const statsText = stats ? `${stats.boards} boards, ${stats.columns} columns, ${stats.tasks} tasks` : "your data";
        notifications.success(
...
function BoardList() {
  ...
  const getBoardActivity = (board) => {
    ...
    const daysSinceUpdate = Math.floor(
      (Date.now() - updatedAt) / (1e3 * 60 * 60 * 24)
    );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-2", children: [
          ...
          isVSCodeWebview() && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: isExportingToFileSystem ? "Exporting..." : "📁 Export to Folder"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                        "Updated ",
                        board.updated_at ? new Date(board.updated_at).toLocaleDateString() : "Unknown date"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center space-x-1", children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-gray-500", style: { fontSize: "9px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: task.updated_at ? new Date(task.updated_at).toLocaleDateString() : "Unknown date" }),
            task.update_reason && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 bg-blue-400 rounded-full", title: "Has update reason" })
          ] })
        ] })
      ]
    }

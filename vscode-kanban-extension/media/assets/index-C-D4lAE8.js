...
const ForwardRef$c = /* @__PURE__ */ reactExports.forwardRef(CheckCircleIcon);
...
const ForwardRef$b = /* @__PURE__ */ reactExports.forwardRef(ChevronLeftIcon);
...
const ForwardRef$a = /* @__PURE__ */ reactExports.forwardRef(ChevronRightIcon);
...
const ForwardRef$9 = /* @__PURE__ */ reactExports.forwardRef(ExclamationCircleIcon);
...
const ForwardRef$8 = /* @__PURE__ */ reactExports.forwardRef(ExclamationTriangleIcon);
...
const ForwardRef$7 = /* @__PURE__ */ reactExports.forwardRef(InformationCircleIcon);
function MoonIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$6 = /* @__PURE__ */ reactExports.forwardRef(MoonIcon);
function PencilIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$5 = /* @__PURE__ */ reactExports.forwardRef(PencilIcon);
function PlusIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$4 = /* @__PURE__ */ reactExports.forwardRef(PlusIcon);
function SunIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$3 = /* @__PURE__ */ reactExports.forwardRef(SunIcon);
function TrashIcon({
  title,
  titleId,
  ...props
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ze,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: type === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$c, { className: "h-6 w-6 text-green-400", "aria-hidden": "true" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$9, { className: "h-6 w-6 text-red-400", "aria-hidden": "true" }) }),
...
function NotificationSystem() {
  ...
  const getIcon = (type) => {
    switch (type) {
      case "success":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$c, { className: "h-5 w-5 text-green-500" });
      case "warning":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$8, { className: "h-5 w-5 text-amber-500" });
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$8, { className: "h-5 w-5 text-red-500" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$7, { className: "h-5 w-5 text-blue-500" });
    }
  };
...
function BoardList() {
  ...
  if (boards && boards.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "Welcome to MCP Kanban!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 mb-8 leading-relaxed", children: "Transform your project management with visual kanban boards. Organize tasks, track progress, and collaborate effectively." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6 text-left bg-gradient-to-br from-indigo-50 via-white to-purple-50 rounded-2xl p-8 mb-8 border border-indigo-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-bold text-gray-900 mb-4 flex items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 bg-indigo-100 rounded-xl flex items-center justify-center mr-3", children: "✨" }),
              "Start your journey:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-gray-700", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-6 bg-indigo-600 text-white rounded-full text-xs font-bold flex items-center justify-center mt-0.5", children: "1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Create your first board" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Give it a name and describe your project goal" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-6 bg-indigo-600 text-white rounded-full text-xs font-bold flex items-center justify-center mt-0.5", children: "2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Add your first tasks" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Break down work into manageable pieces" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-6 bg-indigo-600 text-white rounded-full text-xs font-bold flex items-center justify-center mt-0.5", children: "3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Track your progress" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Move tasks through columns as you work" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-bold text-gray-900 mb-4 flex items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 bg-purple-100 rounded-xl flex items-center justify-center mr-3", children: "🚀" }),
              "Pro features:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-gray-700", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Drag & drop task management" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-purple-500 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "WIP limits for better flow" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-purple-500 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Markdown task descriptions" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-purple-500 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Real-time updates" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-purple-500 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Data export & import" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-purple-500 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "VSCode integration" })
              ] })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "h-6 w-6", "aria-hidden": "true" }),
              "Create your first board"
            ]
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-500 flex items-center space-x-1", style: { fontSize: "10px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isDark ? /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$3, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$6, { className: "h-4 w-4" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "h-3.5 w-3.5", "aria-hidden": "true" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center space-x-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "h-4 w-4 mr-2" }),
                    "Create New Board"
                  ]
                }
              )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(yt, { open: isCreateDialogOpen, onClose: handleCreateDialogClose, className: "relative z-50", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(je, { className: "mx-auto max-w-lg w-full rounded-3xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl p-8 shadow-2xl shadow-indigo-500/20 ring-1 ring-white/20 dark:ring-gray-700/50 border border-indigo-100/50 dark:border-indigo-900/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "w-6 h-6 text-white", "aria-hidden": "true" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: isCreating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "w-4 h-4", "aria-hidden": "true" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-1 flex-1", children: [
                ...
                onCreateTaskClick && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "Add new task",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "h-2.5 w-2.5" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: isOver ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
              ...
              onCreateTaskClick && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: { fontSize: "8px" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "w-2.5 h-2.5 mr-0.5" }),
...
function TaskDetail({
  ...
  const updateTaskMutation = useMutation({
    mutationFn: ({ taskId: taskId2, content }) => updateTask(taskId2, content),
    onSuccess: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-3 flex h-7 items-center space-x-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$5, { className: "h-5 w-5", "aria-hidden": "true" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          onPrevTask && !isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-2.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$b, { className: "h-5 w-5", "aria-hidden": "true" })
              ]
            }
          ),
          onNextTask && !isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-2.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$a, { className: "h-5 w-5", "aria-hidden": "true" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "mt-2 divide-y divide-gray-200 border-t border-b border-gray-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between py-3 text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-gray-900", children: new Date(task.created_at).toLocaleString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between py-3 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-gray-500", children: "Updated" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-gray-900", children: new Date(task.updated_at).toLocaleString() })
            ] }),
            task.update_reason && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-between py-3 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-gray-500", children: "Update Reason" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-gray-900", children: task.update_reason })
            ] })
          ] })
        ] })
      ] }) : null })
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white vscode-compact", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-gray-50 border-b border-gray-200", style: { borderBottomWidth: "1px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center space-x-2 text-xs text-gray-500", style: { fontSize: "9px" }, children: [
